...
square[2] = new Square("Tribe Chest", "FOLLOW INSTRUCTIONS ON TOP CARD", "white");
...
square[17] = new Square("Tribe Chest", "FOLLOW INSTRUCTIONS ON TOP CARD", "white");
...
square[33] = new Square("Tribe Chest", "FOLLOW INSTRUCTIONS ON TOP CARD", "white");
...
communityChestCards[1] = new Card("You have won lifetime home delivery of the New York Times. Collect $10", function() { addamount(10, 'Tribe Chest');});
communityChestCards[2] = new Card("From sale of Macy's stock, you get $45", function() { addamount(45, 'Tribe Chest');});
communityChestCards[3] = new Card("Life insurance matures. Collect $222", function() { addamount(100, 'Tribe Chest');});
communityChestCards[4] = new Card("Deloitte & Touche LLP tax return Collect $20", function() { addamount(20, 'Tribe Chest');});
communityChestCards[5] = new Card("LUV NFT Xmas fund matures. Collect $1111", function() { addamount(100, 'Tribe Chest');});
communityChestCards[6] = new Card("You have won a Delta Airlines trip around the world! Collect $2222", function() { addamount(100, 'Tribe Chest');});
communityChestCards[7] = new Card("Performed a wedding at the The Martin Luther King, Jr. National Historic Site. Receive $1111", function() { addamount(25, 'Tribe Chest');});
communityChestCards[8] = new Card("Pay Grady hospital $111", function() { subtractamount(100, 'Tribe Chest');});
communityChestCards[9] = new Card("You won the GA Lottery! Collect $4444", function() { addamount(200, 'Tribe Chest');});
communityChestCards[10] = new Card("Pay ATL school tax of $1111", function() { subtractamount(150, 'Tribe Chest');});
communityChestCards[11] = new Card("Doctor's fee. Pay $5555", function() { subtractamount(50, 'Tribe Chest');});
communityChestCards[12] = new Card("Atlanta Falcons VS Saints opening tonight. Collect $555 from every player for opening night seats.", function() { collectfromeachplayer(50, 'Tribe Chest');});
