...
function transtext() {
	return '<div style="font-size: 14px; line-height: 1.5;">$RNT<span style="float: right;">$25.</span><br />If 2 Railroads are owned<span style="float: right;">50.</span><br />If 3 &nbsp; &nbsp; " &nbsp; &nbsp; " &nbsp; &nbsp; "<span style="float: right;">100.</span><br />If 4 &nbsp; &nbsp; " &nbsp; &nbsp; " &nbsp; &nbsp; "<span style="float: right;">200.</span></div>';
}

function luxurytax() {
	addAlert(player[turn].name + " paid $2222 for landing on Luxury Tax.");
...
function citytax() {
	addAlert(player[turn].name + " paid $2222 for landing on City Tax.");
	player[turn].pay(200, 0);

	$("#landed").show().text("You landed on City Tax. Pay $333.");
}
...
square[6] = new Square("Buford Highway", "$111", "#87CEEB", 100, 4, 6, 30, 90, 270, 400, 550);
square[7] = new Square("Chance", "FOLLOW INSTRUCTIONS ON TOP CARD", "#FFFFFF");
square[8] = new Square("Piedmont Road", "$555", "#87CEEB", 100, 4, 6, 30, 90, 270, 400, 550);
square[9] = new Square("Decatur Street", "$777", "#87CEEB", 120, 4, 8, 40, 100, 300, 450, 600);
square[10] = new Square("Just Visiting", "", "#FFFFFF");
square[11] = new Square("Ponce de Leon Avenue", "$111", "#FF0080", 140, 5, 10, 50, 150, 450, 625, 750);
square[12] = new Square("Electric Company", "$333", "#FFFFFF", 150, 2);
square[13] = new Square("Freedom Parkway", "$222", "#FF0080", 140, 5, 10, 50, 150, 450, 625, 750);
...
square[21] = new Square("Spring Street", "$555", "#FF0000", 220, 7, 18, 90, 250, 700, 875, 1050);
square[22] = new Square("Chance", "FOLLOW INSTRUCTIONS ON TOP CARD", "#FFFFFF");
square[23] = new Square("10th Street", "$888", "#FF0000", 220, 7, 18, 90, 250, 700, 875, 1050);
square[24] = new Square("14th Street", "$999", "#FF0000", 240, 7, 20, 100, 300, 750, 925, 1100);
square[25] = new Square("Georgia Railroad", "$333", "#FFFFFF", 200, 1);
square[26] = new Square("Peachtree Road", "$777", "#FFFF00", 260, 8, 22, 110, 330, 800, 975, 1150);
square[27] = new Square("Piedmont Avenue", "$444", "#FFFF00", 260, 8, 22, 110, 330, 800, 975, 1150);
square[28] = new Square("Water Works", "$333", "#FFFFFF", 150, 2);
square[29] = new Square("Ansley Mall", "$666", "#FFFF00", 280, 8, 24, 120, 360, 850, 1025, 1200);
...
square[37] = new Square("Perimeter Mall", "$555", "#0000FF", 350, 10, 35, 175, 500, 1100, 1300, 1500);
square[38] = new Square("LUXURY TAX", "Pay $999", "#FFFFFF");
square[39] = new Square("Buckhead", "$666", "#0000FF", 400, 10, 50, 200, 600, 1400, 1700, 2000);
...
chanceCards[0] = new Card("GET OUT OF MAGIC CITY FREE. This card may be kept until needed or traded.", function(p) { p.chanceJailCard=true; updateOwned();});
chanceCards[1] = new Card("Make General Repairs on All Your Property. For each house pay $222. For each hotel $444.", function() { streetrepairs(25, 100);});
chanceCards[2] = new Card("Speeding fine $222.", function() { subtractamount(15, 'Chance');});
chanceCards[3] = new Card("You have been elected chairman of the board. Pay each player $1500.", function() { payeachplayer(50, 'Chance');});
...
chanceCards[6] = new Card("Bank pays you dividend of $444.", function() { addamount(50, 'Chance');});
chanceCards[7] = new Card("ADVANCE TO THE NEAREST RAILROAD. If UNOWNED, you may buy it from the Bank. If OWNED, pay owner twice the $RNTal to which they are otherwise entitled.", function() { advanceToNearestRailroad();});
chanceCards[8] = new Card("Pay poor tax of $555.", function() { subtractamount(15, 'Chance');});
chanceCards[9] = new Card("Take a trip to Reading Rail Road. If you pass \"GO\" collect $444.", function() { advance(5);});
chanceCards[10] = new Card("ADVANCE to Buckhead.", function() { advance(39);});
chanceCards[11] = new Card("ADVANCE to 14th Street. If you pass \"GO\" collect $200.", function() { advance(24);});
chanceCards[12] = new Card("Your building loan matures. Collect $1111.", function() { addamount(150, 'Chance');});
chanceCards[13] = new Card("ADVANCE TO THE NEAREST RAILROAD. If UNOWNED, you may buy it from the Bank. If OWNED, pay owner twice the $RNTal to which they are otherwise entitled.", function() { advanceToNearestRailroad();});
chanceCards[14] = new Card("ADVANCE to Ponce de Leon Avenue. If you pass \"GO\" collect $333.", function() { advance(11);});
chanceCards[15] = new Card("Go to Magic City. Go Directly to Magic City. Do not pass \"GO\". Do not collect $333.", function() { gotojail();});
